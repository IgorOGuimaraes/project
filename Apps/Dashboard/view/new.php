...
<main>
            ...
            <div class="col s12 m8 offset-m1 xl7 offset-xl1">
                <div id="introduction" class="section scrollspy">
                    <p> Select allows user input through specified options. Make sure you wrap it in a <code
                                class="language-markup">.input-field</code> for proper alignment with other text fields.
                        Remember that this is a jQuery plugin so make sure you <a href="#initialization">initialize</a>
                    ...
                    <div class="row">
                        <form class="col s12">
                            <div class="row">
                                ...
                                <div class="col s12">
                                    <br>
                                    <p>You can add the property <code class="language-markup">multiple</code> to get the
                                        multiple select and select several options.</p>
                                </div>
                                <div class="input-field col s12 m6">
                                    <select multiple>
                                        <option value="" disabled selected>Choose your option</option>
                                ...
                                <div class="col s12">
                                    <br>
                                    <p>You can add icons to your options in any type of select. In the option you add
                                        the image source with the <code class="language-markup">data-icon</code>
                                        attribute. You can add the <code class="language-markup">left</code> or <code
                                                class="language-markup">right</code> class to align your icon. You can
                                        also add the <code class="language-markup">circle</code> class to your icon.</p>
                                </div>
                                <div class="input-field col s12 m6">
                                    <select class="icons">
                                        <option value="" disabled selected>Choose your option</option>
                                        <option value="" data-icon="images/sample-1.jpg" class="circle">example 1
                                        </option>
                                ...
                                <div class="input-field col s12 m6">
                                    <select class="icons">
                                        <option value="" disabled selected>Choose your option</option>
                                        <option value="" data-icon="images/sample-1.jpg" class="left circle">example 1
                                        </option>
                                        <option value="" data-icon="images/office.jpg" class="left circle">example 2
                                        </option>
                                        <option value="" data-icon="images/yuna.jpg" class="left circle">example 3
                                        </option>
                                    </select>
                                    <label>Images in select</label>
                                </div>
                                <div class="col s12">
                                    <br>
                                    <p>You can add the class <code class="language-markup">browser-default</code> to get
  ...
  &lt;/select>
                ...
                <div id="initialization" class="scrollspy section">
                    ...
                    <p>You must initialize the select element as shown below. In addition, you will need a separate call
                        for any dynamically generated select elements your page generates.</p>

                    <pre><code class="language-javascript">
  var elem = document.querySelector('select');
  var instance = new M.Select(elem, options);
...
instance.destroy();
                ...
                <div id="properties" class="scrollspy section">
                    ...
                    <table class="striped">
                        ...
                        <tr>
                            <td>valuesSelected</td>
                            <td>Array</td>
                            <td>Array of values selected.</td>
                        </tr>
                        <tr>
                            <td>wrapper</td>
                            <td>Element</td>
                ...
                <div id="disabled" class="section scrollspy">
                    <div class="row">
                        <div class="col s12">
                            ...
                            <p>You can also add <code class="language-markup">disabled</code> to the select element to
                                make the whole thing disabled. Or if you add <code
                                        class="language-markup">disabled</code> to the options, the individual options
                                will be unselectable. </p>
                        </div>
                ...
                <div class="toc-wrapper">
                    <div class="buysellads hide-on-small-only">
                        ...
                        <script async type="text/javascript"
                                src="//cdn.carbonads.com/carbon.js?zoneid=1673&serve=C6AILKT&placement=materializecss"
                    ...
                    <div style="height: 1px;">
                        <ul class="section table-of-contents">
                            ...
                            <li><a href="#disabled">Disabled Styles</a></li>
                        </ul>
                    </div>
                </div>
            </div>
