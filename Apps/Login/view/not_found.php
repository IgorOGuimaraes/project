...
<head>
    ...
    <title>404 NOT FROUND | DAT Automation</title>
...
<div class="row ">
    <div class="col s8 offset-l2 " style="padding-top:15% !important;">
        <div class="card-panel teal ">
            <span class="white-text center">
                <h1>404 NOT FOUND 😰</h1>
                <br>
                <p class="header">OPS! Sorry but we could't find anywhere</p>
                <br>
